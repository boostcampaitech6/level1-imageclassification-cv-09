...
class windows_tkinter:
    ...
    def next_button_action(self,event=None):
        ...
        self.age_label['text'] = age_str[self.train_csv.iloc[self.current_number][4]//30]+f" {self.train_csv.iloc[self.current_number][4]}살"
    ...
    def okay_button_action(self, event=None):
        self.button_flag("Okay")

    def error_button_action(self, event=None):
        self.button_flag("Error")
    ...
    def display_window(self):
        ...
        self.window.bind('<n>', self.next_button_action)
        self.window.bind('<e>', self.error_button_action)
        self.window.bind('<o>', self.okay_button_action)
...
if __name__ == "__main__":
    ...
    if user_input is not None:
        ...
        ss = windows_tkinter(start_number=user_input,train_csv_path=train_mask_path,train_check_path=os.path.join(data_path,"train_check.csv"),data_path = data_path,image_size=100)
        ss.display_window()
